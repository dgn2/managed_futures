...
We can iterate over each program with historical data going back further than `r minDate` and extract the return data, adding each CTA program return stream to the group.
