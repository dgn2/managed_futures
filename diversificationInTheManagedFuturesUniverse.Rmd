...
# create the table
knitr::kable(t(distributionAboveThreshold[systematicThreshold:100,1:2]),caption='Distribution of Programs with Significant Systematic Components')
```
...
plot(varianceScenarios[,1]*100,portfolioV[,1]*100,
  ...
  main='Factor Sensitivity: Portfolio Volatility &  1st Factor Importance')
```
